...
jQuery(function($){
    ...
    if(username){
        ...
        $('nav').on('click','a',function(e){
           ...
           location.href='http://localhost/1808/1809/zcx/src/html/goodslist.html?username='+username+'&name='+params;
        });
    ...
    // 侧栏购物车跳到结算页面
        ...
        // 跳到列表页
            $('nav').on('click','a',function(e){
                let params=encodeURI(this.innerText);
               location.href='http://localhost/1808/1809/zcx/src/html/goodslist.html?name='+params;
            });
